...
def transfer(self, amount, transform_account, bank_kind, password, withdraw_password):
    ...
    if(waitRes == True):
        ...
        if(waitTransferHomeAct):
            ...
            LoginActivity = self.wait_activity("com.ccb.framework.security.login.internal.view.LoginActivity", timeout=20)
            if(LoginActivity):
                ...
                SmartTransferMainAct = self.wait_activity("com.ccb.transfer.smarttransfer.view.SmartTransferMainAct", timeout=20)
                if(SmartTransferMainAct):
                    ...
                    self(resourceId="com.chinamworld.main:id/tv_bank").click()
                    time.sleep(20.0)
                    self.xpath('//android.widget.GridView/android.widget.LinearLayout[15]/android.widget.ImageView[1]').click()
                    time.sleep(10.0)
