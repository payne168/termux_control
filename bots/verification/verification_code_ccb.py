...
class VerificationCodeCcb:
    ...
    def image_str(self):
        ...
        result = pytesseract.image_to_string(image, lang='eng', config="--psm 6 --tessdata-dir /data/data/com.termux/files/home/storage/shared/water_drop_init/termux_control/bots/verification/tessdata")  # 图片转文字
